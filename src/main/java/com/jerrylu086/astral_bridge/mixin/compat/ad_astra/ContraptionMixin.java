...
public abstract class ContraptionMixin {
    ...
    private float isLaunchPadFlipped(BlockState instance, BlockGetter blockGetter, BlockPos blockPos, Operation<Float> original,
        ...
        return (state.getBlock() instanceof LaunchPad && (transform.rotation.ordinal() & 1) == 1 || state.getBlock() instanceof SlidingDoorBlock)
                       && transform.rotationAxis != Axis.Y ? -1 : original.call(instance, blockGetter, blockPos);
    }
}
